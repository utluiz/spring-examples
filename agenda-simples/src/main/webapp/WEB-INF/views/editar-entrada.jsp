...
<head>
   <meta charset="utf-8">
	...
	<title>Editar Entrada :: Agenda Pessoal</title>
...
<body>
    ...
    <div class="container-fluid">
      ...
      <form class="form-horizontal" id="form-editar-entrada" action="entradas.html" method="post">
		  <fieldset>
		    ...
		    <div class="form-group">
		      <div class="col-lg-10 col-lg-offset-2">
		        ...
		        <a href="entradas.html" class="btn btn-default">Voltar</a>
		      </div>
		    </div>
		  </fieldset>
		</form>
